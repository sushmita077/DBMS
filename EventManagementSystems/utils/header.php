...
<style>
.bgImage {
    background-image: url(images/cs032.jpg);
...
<header class="bgImage" > 
    <nav style="padding:20px;background-color:black; color:white;" class="navbar" >
        <div class="container">
    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                ...
                <p style="font-style: bold; font-style:italic;">"Limitation-It's just your imagination,so just stop thinking about limitation and think about your goal and run towards it to acheive the peak of your goal:)"</p>
                <br>
